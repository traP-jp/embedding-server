...
func setupTest(t *testing.T) *testSetup {
	...
	jobFile := service.NewJobFileService(t.TempDir())
...
func (c *testCombinedRepo) GetJobPayload(ctx context.Context, id uuid.UUID) (json.RawMessage, error) {
	return c.job.GetJobPayload(ctx, id)
}
func (c *testCombinedRepo) CreateJob(ctx context.Context, id uuid.UUID, payload json.RawMessage) error {
	return c.job.CreateJob(ctx, id, payload)
}
func (c *testCombinedRepo) ClaimJob(ctx context.Context) (uuid.UUID, json.RawMessage, error) {
